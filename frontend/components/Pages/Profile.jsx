        ...
        return (
          <Box p={3}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <TextField fullWidth label="Blood Group" defaultValue="ab-" />
              </Grid>
              <Grid item xs={6}>
                <TextField fullWidth label="Medical Condition" defaultValue="None" />
              </Grid>
              <Grid item xs={6}>
                <TextField fullWidth label="Date of Joining" defaultValue="01-08-2024" />
              </Grid>
              <Grid item xs={6}>
                <TextField fullWidth label="Phone Number" defaultValue="(321) 654-987" />
              </Grid>
              <Grid item xs={6}>
                <TextField fullWidth label="Email Address" defaultValue="rdjiron.man@example.com" />
              </Grid>
              <Grid item xs={6}>
                <TextField fullWidth label="City" defaultValue="chennai" />
              </Grid>
              <Grid item xs={6}>
                <TextField fullWidth label="Country" defaultValue="india" />
              </Grid>
            </Grid>
            <Box mt={2}>
              <Button
      ...
      case 2:
        return (
          <Box p={3}>
            ...
            <Typography variant="body1" mt={2}>1. Completed 80kg Deadlift</Typography>
            <Typography variant="body1">2. Ran 10km under 35 minutes</Typography>
            <Typography variant="body1">3. Consistent workouts for 3 months</Typography>
          </Box>
        );
      default:
        return null;
